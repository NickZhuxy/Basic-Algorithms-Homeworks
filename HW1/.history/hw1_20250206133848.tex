...
\begin{document}
    ...
    \begin{itemize}
        \item $(\log n)^2 \in o(\sqrt{n})$ \\
        We have
        \[
        \lim_{n\to\infty} \frac{(\log n)^2}{\sqrt{n}} = \lim_{n\to\infty} \frac{2\log n}{\sqrt{n}} = 0
        \]
        Therefore, $(\log n)^2 \in o(\sqrt{n})$.
        \item $\sqrt{n} \in o(2^{\log_3 n})$ \\
        We have
        \[
        \lim_{n\to\infty} \frac{\sqrt{n}}{n^{0.63}} = \lim_{n\to\infty} \frac{1}{n^{0.63-0.5}} = 0
        \]
        Therefore, $\sqrt{n} \in o(2^{\log_3 n})$.
        \item $2^{\log_3 n} \in o(n^3)$ \\
        We have
        \[
        \lim_{n\to\infty} \frac{n^{0.63}}{n^3} = \lim_{n\to\infty} \frac{1}{n^{3-0.63}} = 0
        \]
        Therefore, $2^{\log_3 n} \in o(n^3)$.
        \item $n^3 \in o(8^{n/2})$ \\
        We have
        \[
        \lim_{n\to\infty} \frac{n^3}{(2\sqrt{2})^n} = \lim_{n\to\infty} \frac{n^3}{2^n\cdot 2^{n/2}} = \lim_{n\to\infty} \frac{n^3}{2^{3n/2}} = 0
        \]
        Therefore, $n^3 \in o(8^{n/2})$.
        \item $8^{n/2} \in o(3^n)$ \\
        We have
        \[
        \lim_{n\to\infty} \frac{(2\sqrt{2})^n}{3^n} = \lim_{n\to\infty} \left(\frac{2\sqrt{2}}{3}\right)^n = 0
