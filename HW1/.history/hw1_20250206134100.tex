...
\begin{document}
    ...
    \paragraph{1. \((\log n)^2 \in o(\sqrt{n})\):}
    We need to show that
    \[
    \lim_{n\to\infty}\frac{(\log n)^2}{\sqrt{n}} = 0.
    \]
    Substitute \(n = 2^m\) (since \(\log n\) is base 2). Then,
    \[
    ...
    \paragraph{2. \(\sqrt{n} \in o(2^{\log_3 n})\):}
    Since \(2^{\log_3 n} = n^{\log_3 2}\), we have
    \[
    \frac{\sqrt{n}}{2^{\log_3 n}} = \frac{n^{1/2}}{n^{\log_3 2}} = n^{\,1/2-\log_3 2}.
    \]
    Because \(1/2 - \log_3 2 < 0\), it follows that the limit is 0:
    \[
    \lim_{n\to\infty} n^{\,1/2-\log_3 2} = 0.
    \]

    \paragraph{3. \(2^{\log_3 n} \in o(n^3)\):}
    Since \(2^{\log_3 n} = n^{\log_3 2}\),
    \[
    \frac{2^{\log_3 n}}{n^3} = \frac{n^{\log_3 2}}{n^3} = n^{\,\log_3 2-3}.
    \]
    Because \(\log_3 2-3 < 0\), the limit is 0.

    \paragraph{4. \(n^3 \in o(8^{n/2})\):}
    Here,
    \[
    \lim_{n\to\infty} \frac{n^3}{8^{n/2}} = 0,
    \]
    since the exponential function \(8^{n/2}\) grows much faster than the polynomial \(n^3\).

    \paragraph{5. \(8^{n/2} \in o(3^n)\):}
    We have
    \[
    \frac{8^{n/2}}{3^n} = \left(\frac{8^{1/2}}{3}\right)^n = \left(\frac{2\sqrt{2}}{3}\right)^n.
    \]
    Since \(\frac{2\sqrt{2}}{3} < 1\), it follows that the limit is 0:
    \[
