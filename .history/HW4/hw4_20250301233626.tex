...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \end{itemize}
    \end{enumerate}
    Note that it is not necessary to consider cases xswhere one or both elements are already in \(b\) because once an element is in \(b\), it has already been eliminated as a candidate for either the minimum or maximum. 
