...
\begin{document}
    ...
    \begin{itemize}
        \item When the majority of phones are malfunctioning, the malfunctioning phones can respond arbitrarily. In particular, they can collude and always output $1$ (claiming the other phone is working) regardless of the true status.
        \item With such adversarial behavior, consider two malfunctioning phones. If paired, they may both output $1$, resulting in $M(A,B) = 11$, which is identical to the response when both phones are actually working.
