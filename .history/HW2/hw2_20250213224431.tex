...
\begin{document}
    ...
    \begin{itemize}
        \item When the majority of phones are malfunctioning, the malfunctioning phones can respond arbitrarily. In particular, they can always output $1$ (claiming the other phone is working) regardless of the true status.
