...
\begin{document}
    ...
    Given the recurrence, we will first draw the recursion tree, then use is to sum all the costs to reach the conclusion.
    ...
    \textbf{Conclusion:}  
    The asymptotic run-time corresponding to the recurrence is \(\Theta(n)\).
