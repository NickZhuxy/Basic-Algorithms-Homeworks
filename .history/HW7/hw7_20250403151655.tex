...
\begin{document}
    ...
    %Problem 1
    \begin{tcolorbox}[title={Problem 1 (Interval Scheduling with Revenue, 35 pts)}, before upper=\setlength{\parindent}{1em}]
    ...
    %Problem 2
    \begin{tcolorbox}[title={Problem 2 (Min Interval Scheduling, 35 pts)}, before upper=\setlength{\parindent}{1em}]
    ...
    %Problem 3
    \begin{tcolorbox}[title={Problem 3 (Huffman Encoding Practice, 15 points)}, before upper=\setlength{\parindent}{1em}]
    ...
    % Problem 4
    \begin{tcolorbox}[title={Problem 4 (Huffman Encoding, Short Answers, 15 points)}, before upper=\setlength{\parindent}{1em}]
        \begin{enumerate}[(a)]
