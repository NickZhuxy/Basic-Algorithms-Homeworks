    ...
    \section*{Solution}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Thus, the total runtime is $O(n) + O(n) + O(n^2) = O(n^2)$.
            \end{itemize}
            \item \textbf{Space Complexity:} The algorithm uses a 2D table of size $(n+1) \times (n+1)$, resulting in a space complexity of $O(n^2)$.
        \end{itemize}
    \newpage
